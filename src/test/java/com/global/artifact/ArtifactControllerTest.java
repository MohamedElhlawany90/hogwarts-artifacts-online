...
class ArtifactControllerTest {
	...
	@Test
	void testFingArtifactByIdNotFound() throws Exception  {
		
		//Given
		given(this.artifactService.findById("1250808601744904191"))
		.willThrow(new ArtifactNotFoundExeption("1250808601744904191"));
	...
	void testAddArtifactSuccess() throws Exception {
		...
		ArtifactDto artifactDto = new ArtifactDto(null
				                                  ,"Remembrall"
				                                  , "A Remembral was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered."
				                                  ,"ImageUrl"
				                                  , null);
		...
		String json =  this.objectMapper.writeValueAsString(artifactDto);
		 ...
		 savedArtifact.setDescription("A Remembral was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered.");
	...
	@Test
	void testUpdateArtifactSuccesss() throws Exception {
	...
	@Test
	void testUpdateArtifactErrorWithNoExistenId() throws Exception {
		...
		String json =  this.objectMapper.writeValueAsString(artifactDto);
		 ...
		 given(this.artifactService.update(eq("1250808601744904192"),Mockito.any(Artifact.class))).willThrow(new ArtifactNotFoundExeption("1250808601744904192"));
	...
	void testDeleteArtifactErrorWithNonExistenId() throws Exception {
		...
		doThrow(new ArtifactNotFoundExeption("1250808601744904191")).when(this.artifactService).delete("1250808601744904191");
