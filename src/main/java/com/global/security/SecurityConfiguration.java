...
public class SecurityConfiguration {
	...
	public SecurityConfiguration(CustomBasicAuthenticationEntryPoint customBasicAuthenticationEntryPoint, CustomBearerTokenAuthenticationEntryPoint customBearerTokenAuthenticationEntryPoint, CustomBearerTokenAccessDeniedHandler customBearerTokenAccessDeniedHandler) throws NoSuchAlgorithmException {
		...
		keyPairGenerator.initialize(2048); // The generated key will have a size of 2048bits.
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		return http
				...
				.headers(headers -> headers.frameOptions(FrameOptionsConfig::disable)) // this is the updated method instead of the down one
				// .headers(headers -> headers.frameOptions()null.disable()) // This is for H2 browser console access.
