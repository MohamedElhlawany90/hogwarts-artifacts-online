...
public class ExeptionHandlerAdvice {
	...
	Result handleAuthenticationNotFoundExeption(Exception ex) {
	...
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	Result handleAccountStatusExeption(AccountStatusException ex) {
	...
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	Result handleInvalidBearerTokenExeption(InvalidBearerTokenException ex) {
	...
	Result handleAccessDeniedExeption(AccessDeniedException ex) {
	...
	Result handleOtherExeption(Exception ex) {
